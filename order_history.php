      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-12">
          <div class="order-history">
            <div class="row">
              <div class="col-md-12">
                <table class="order-detailui table-responsive">
                  <tr class="order-detailtr">
                    <td><img src="assets/img/right-sign.png" style="width: 50px;"></td>
                    <td><strong>Order Id:</strong><br> 01234567890</td>
                    <td><strong>Status:</strong><br> Success</td>
                    <td><strong>Price:</strong><br> 120</td>
                    <td>
                      <div class="order-status">
                        <div class="circle-bindi"></div>
                        <span>Delivered on April 16, 2020</span>
                        <p>Your item has been delivered</p>
                        <a href="#" class="review-status"><i class="fa fa-star"></i>Rate &amp; Review Product</a>
                      </div>
                    </td>
                  </tr>
                  <tr class="order-detailtr">
