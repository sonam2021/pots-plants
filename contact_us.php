...
<body>
  ...
  <section class="pt-50px pb-100px">
    <div class="wrapper">
      <div class="row">
          <div class="col-lg-4 col-md-6">
              <div class="contact-info-box">
                  ...
                  <h3>Our Address</h3>
                  <p>SCO-xyz, near Police Post, Amar Market, Sector xyz, Karnal, Haryana 132001</p>
              </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
              <div class="contact-info-box">
                  ...
                  <p>E-mail: <a href="mailto:hello@dibiz.com">info@plants.in</a></p>
              </div>
          </div>
      ...
      <div class="section-title pt-50px">
